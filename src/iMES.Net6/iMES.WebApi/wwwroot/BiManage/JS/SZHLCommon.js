...
var ComFunJS = new Object({
    ...
    */
    ...
    GetBMPeople: function (dom) {
        ...
        ComFunJS.winbtnwin("/BiManage/Base/UserSelect.html", "选择人员", 900, 540, {}, function (layero, index) {
    ...
    winviewform: function (url, title, width, height, callbact) {
        ...
        var height = height || $(window).height() - 80; //$("body").height();
        var optionwin = {
            type: 2,
            fix: true, //不固定
        ...
        if ($(".szhl_getPeoples:hidden").length > 0) {
            $(".szhl_getPeoples:hidden").each(function () {
                ...
                $panelsc.find('.btn-upload').bind('click', function () {
                    ...
                    top.ComFunJS.winbtnwin("/BiManage/Base/UserSelect.html?issignle=" + issignle + peopleType, "选择人员", 900, 470, {}, function (layero, index) {
                        var frameid = $("iframe", $(layero)).attr('id');
        ...
        if ($(".szhl_branch:hidden").length > 0) {
            $(".szhl_branch:hidden").each(function () {
                ...
                $panelsc.find('.btn-upload').bind('click', function () {
                    ...
                    top.$("body").data("checkvalue", $input.val());
                    top.ComFunJS.winbtnwin("/BiManage/AppPage/XTGL/BranchSelect.html?issignle=" + issignle + peopleType, "选择部门", 500, 470, {}, function (layero, index) {
                ...
                for (i = 0; i < rs.length; i++) {
                    for (n = 0; n < ComFunJS.facePath.length; n++) {
                        if (ComFunJS.facePath[n].faceName == rs[i].substring(1, rs[i].length - 1)) {
                            var t = "<img title=\"" + ComFunJS.facePath[n].faceName + "\" style='display: initial;' src=\"/BiManage/Images/face/" + ComFunJS.facePath[n].facePath + "\" />";
    ...
    inithighgrid: function (option, tabledata) {
        ...
        ComFunJS.loadJs("/BiManage/JS/YanGrid/jqwidgets/jqgridall.js", function () {
