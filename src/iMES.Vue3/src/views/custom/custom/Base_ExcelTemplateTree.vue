<template>
  <div class="goods-tree">
    <!-- 左边树结构 -->
    <div class="tree-left">
      <div class="tree-left-title">导出Excel模版分类</div>
...
import excel from './Base_ExcelTemplate.vue';
export default {
  components: {
    excel
  },
  ...
  created() {
    //从打印模版分类Base_PrintCatalogController加载左边tree数据
    this.http.get('api/Base_PrintCatalog/getList').then((result) => {
      //记录原始数据
